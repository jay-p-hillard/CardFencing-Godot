...
> Note: this is the in-development Godot version, aiming for a complete playable game across five modes with UI and (eventually) online play. For a finished, compact proof of concept of the same core mechanics, see the [Java version](../CardFencing).
